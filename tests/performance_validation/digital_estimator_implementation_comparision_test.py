...
def test_digital_estimator_implementation_comparision():
    ...
    clock = Clock(Ts)
    digitalControl1 = DigitalControl(clock, M)
    digitalControl2 = DigitalControl(clock, M)
    digitalControl3 = DigitalControl(clock, M)
    digitalControl4 = DigitalControl(clock, M)
    ...
    e4_error /= window
    print(
        f"""Batch estimator error:        {e1_error}, {10 *
