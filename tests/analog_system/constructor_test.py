...
def test_chain_of_integrators_fixture(chain_of_integrators):
    np.testing.assert_allclose(chain_of_integrators["A"],
                               chain_of_integrators["system"].a)
    np.testing.assert_allclose(
        chain_of_integrators["B"], chain_of_integrators["system"].b)
    np.testing.assert_allclose(
        chain_of_integrators["C"], chain_of_integrators["system"].c)
    np.testing.assert_allclose(chain_of_integrators["Gamma"],
                               chain_of_integrators["system"].gamma)
    np.testing.assert_allclose(chain_of_integrators["Gamma_tilde"],
