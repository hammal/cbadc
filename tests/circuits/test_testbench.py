...
# def test_testbench_get_ngspice():
#     analog_frontend = get_leap_frog(N=N, ENOB=ENOB, BW=BW)
#     testbench = StateSpaceTestBench(
#         analog_frontend=StateSpaceAnalogFrontend(analog_frontend, vdd, vgnd),
#         input_signals=[
#             SinusoidalVoltageSource(
#                 offset=offset,
#                 amplitude=amplitude,
...
#     print(testbench.get_ngspice())

#     assert True


# def test_testbench_get_spectre():
#     analog_frontend = get_leap_frog(N=N, ENOB=ENOB, BW=BW)
#     testbench = StateSpaceTestBench(
#         analog_frontend=StateSpaceAnalogFrontend(analog_frontend, vdd, vgnd),
#         input_signals=[
...
#     print(testbench.get_spectre()[0])
#     print(testbench.get_spectre()[1])

#     assert True


def test_opamp_testbench_get_ngspice():
    analog_frontend = get_leap_frog(N=N, ENOB=ENOB, BW=BW)
    vdd = 1.8
    GBWP = 1e8
    DC_gain = 1e2
...
# def test_opamp_testbench_get_spectre():
#     analog_frontend = get_leap_frog(N=N, ENOB=ENOB, BW=BW)
#     vdd = 1.8
#     GBWP = 1e8
#     DC_gain = 1e2
