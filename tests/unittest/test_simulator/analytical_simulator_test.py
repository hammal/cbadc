...
def test_initialization():
    ...
    sim = cbadc.simulator.analytical_simulator.AnalyticalSimulator(
...
def test_iterator():
    ...
    analog_system = cbadc.analog_system.AnalogSystem(A, B, CT, Gamma, Gamma_tildeT)
    sim = cbadc.simulator.analytical_simulator.AnalyticalSimulator(
        analog_system, digitalControl, analogSignals, clock, t_stop=Ts * 1000
    )
...
def test_analytical_vs_numerical_pre_computations():
    ...
    an_sim = cbadc.simulator.analytical_simulator.AnalyticalSimulator(
        analog_system,
