...
Additionally, as simulating a control-bounded ADC is typically
a computationally intense task, compared to filtering, several
control signal sequences from default architectures and
