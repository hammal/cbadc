...
class StateSpaceTestBench(TestBench):
    def __init__(
        ...
        super().__init__(
            ...
            clock,
            vdd_voltage,
            number_of_control_signals=analog_frontend.analog_filter.M,
        ...
        for l in range(self.Xaf.analog_frontend.analog_filter.L):
            # Connect input signal to terminals
            self.connects(
        ...
        for m in range(self.Xaf.analog_frontend.analog_filter.M):
            self.connects(
